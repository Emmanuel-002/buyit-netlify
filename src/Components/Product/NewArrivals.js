...
const NewArrivals = () => {
    ...
    {id: 2,  category: 'Wrist Watch', src: '/images/fashionIcon.jpg', description: 'This is the part designated for description of the sales product we offer in NewLife Global Investment', price: '$19.99',},
    {id: 3,  category: 'Computer', src: '/images/electronicsIcon.jpg', description: 'This is the part designated for description of the sales product we offer in NewLife Global Investment', price: '$499.99',},
    ...
    {id: 5,  category: 'Total Quartz', src: '/images/automechanicsIcon.jpg', description: 'This is the part designated for description of the sales product we offer in NewLife Global Investment', price: '$9.99',},
